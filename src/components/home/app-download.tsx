        ...
        <div className="rounded-3xl border border-gold/20 bg-gradient-to-br from-card via-card to-gold/5 p-8 sm:p-12 lg:p-16 text-center shadow-2xl">
          ...
          >
            <span className="text-gold text-sm font-semibold tracking-widest uppercase mb-3 block">
              {t("এখনই ডাউনলোড করুন", "Download Now")}
            </span>
            <h2 id="download-heading" className="text-3xl sm:text-4xl lg:text-5xl font-display font-bold text-foreground mb-5 text-balance">
              {t(
                <>islahbd অ্যাপ <span className="text-gold">বিনামূল্যে</span> পান</>,
                <>Get the islahbd App <span className="text-gold">For Free</span></>
              )}
            </h2>
            <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-8 text-pretty">
              {t(
                "মারকাজুল ইহসানের অফিশিয়াল ইসলামিক অ্যাপ এখন উপলব্ধ। ১৫+ ফিচার সম্পূর্ণ বিনামূল্যে।",
                "Markazul Ihsan's official Islamic app is now available. 15+ features completely free."
              )}
            </p>
          ...
          <div className="flex items-center justify-center gap-4 mt-10">
            ...
            >
              ...
              <div className="text-left">
                <div className="text-[10px] text-muted-foreground">{t("ডাউনলোড করুন", "Download on")}</div>
            ...
            >
              ...
              <div className="text-left">
                <div className="text-[10px] text-muted-foreground">{t("পান", "Get it on")}</div>
